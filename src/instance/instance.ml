               ...
               ~french:
                 (md
                    "Stage de 6 semaines encadré par David Coeurjolly and \
                     ...
                     six semaines. J'ai utilisés des outils tels que Polyscope \
               ...
               ~french:
                 (md
                    "Compétition de programmation/algorithmique universitaire.\n\
                     ...
                     Classement de mon équipe : 37 sur 95 équipes répresentant \
               ...
               ~french:
                 (md
                    "La compilation des langages de programmation est un sujet \
                     qui m'intéresse beaucoup. Dans ce domaine, j'ai écris un \
               ...
               ~english:
                 (md
                    "I am very interested in compilation. In this domain, for \
                     ...
                     f-omega type system. The code is available \
