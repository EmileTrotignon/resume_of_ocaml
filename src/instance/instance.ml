...
let emile =
  Resume.make ~firstname:(I "Émile") ~lastname:(I "Trotignon")
    ~intro:
      (v
         ~french:
           "Étudiant en informatique à l'ENS Paris-Saclay, je suis très interessé par OCaml et plus généralement par \
            les langues de programmation et la compilation."
         ~english:
    ...
    ~formations:
      ...
      ; formation (I "Université Lyon 1 Claude-Bernard")
          (v ~french:"L2 Informatique - mathématiques"
             ~english:"Second year of Bachelor in Computer Science and Mathematics" )
      ...
      ; formation
          ...
          (v ~french:"CPGE MPSI" ~english:"First year of Bachelor in engineering")
      ...
      [ experience
          ...
          ~description:
            (v
               ~french:
                 (atom
                    "Stage de 4.5 mois supervisé par Vincent Laviron et Pierre Chambart. Généralisation de \
                     l'optimisation des appel récursifs en queue modulo constructeurs." )
               ~english:
                 (atom
                    "4.5-month intership tutored by Vincent Laviron and Pierre Chambart. Generalisation of recursive \
                     tail-call optimisation modulo constructor" ) )
          (v ~french:"OCamlpro, équipe Flambda" ~english:"OCamlpro, team Flambda")
      ...
      ; experience
          ...
          ~description:
            (v
               ~french:
                 (atom
                    "Stage de M1 de 5 mois encadré par François Pottier. Améliorations de Menhir, un générateur de \
                     parser LR(1) pour OCaml :\n\
                     Augmentation de la sécurité grâce aux GADTs, ce qui autorises des optimisation plus aggresives. \
                     Nombre d'allocations divisée par 4 et vitesse augmentée de 10%, sur des grammaires variées. " )
               ~english:
                 (atom
                    "Five-month internship tutored by François Pottier. Improvements the code generated by Menhir, the \
                     LR(1) parser generator for OCaml :\n\
                     Typing with GADTs for increased safety, allowing bolder optimisations. The number of allocations \
                     was divided by 4, and the speed increased by 10%, across various grammars." ) )
      ...
      ; experience
          ...
          ~description:
            (v
               ~french:
                 [ S
                     "Stage de 6 semaines encadré par David Coeurjolly and Vincent Nivoliers. Le sujet du stage était \
                      d'échantillonner la surface d'une mesh potentiellement défectueuse. J'ai beaucoup programmé en \
                      C++ pendant ces six semaines. J'ai utilisés des outils tels que Polyscope et LIBIGL. Mon rapport \
                      de stage est disponible à cette adresse : "
               ...
               ~french:
                 [ S
                     "Dans le cadre d'un mission pour la junior entreprise de l'ENS Paris-Saclay de 6 semaines, j'ai \
                      participé au développement du site web d'Expert People, une nouvelle plateforme de freelancing. \
      ...
      ; experience
          ...
          ~description:
            (v
               ~french:
                 [ S
                     "Stage de 2 mois. Écriture de shaders HLSL, découverte de DirectX, Windows Form, expérience avec \
                      OpenCV.\n\
      ...
      [ skill (I "Compilation") Strong
          ~description:
            (v
               ...
               ~english:
                 [ S
                     "I am very interested in compilation. In this domain, for a M2 course, I have written a type \
                      checker for the f-omega type system. The code is available here :"
               ...
               ~french:
                 [ S
                     "Durant mes études, j'ai étudié différents aspects de l'informatique théorique :\n\
                      Sémantique des langages de programmation, théorie du calcul parallèle en mémoire partagée, \
                      langages formels, calculabilité, logique.\n\
               ...
               ~english:
                 [ S
                     "I have studied different aspect of fundamental Computer Science :\n\
                      Programming languages semantics, theory of parallel computing with shared memory, formal \
                      languages, calculability, logic.\n\
               ...
               ~french:
                 [ S
                     "J'aime beaucoup les langages de programmation fonctionnels, ainsi que les systèmes de type \
                      avancés. Je programme en Ocaml depuis le début de mes études, et j'apprécie beaucoup ce langage. \
                      J'ai un peu d'expérience en Scala ainsi qu'en Rust, et j'ai beaucoup expérimenté avec les \
                      fonctionnalités avancées de C++.\n\
                      J'ai aussi publié un paquet sur Opam, le gestionnaire de paquets d'Ocaml : "
                 ; f "url" "https://github.com/EmileTrotignon/embedded_ocaml_templates"
      ...
      ; skill (I "Proof assistants and verification") Basic
          ~description:
            (v
               ~french:
                 (atom
                    "J'ai suivi un cours sur l'assistant de preuve Coq, et l'outil de vérification Why3. Je ne suis \
                     pas autonome avec ces outils, mais j'aimerai beaucoup en apprendre plus." )
               ~english:
                 (atom
                    "I have taken a course on the Coq proof assistant, and one on the Why3 verification framework. I \
                     am not fluent with neither of this tools, but I would love to become more familiar with them." ) )
      ...
      ; skill
          ...
          ~description:
            (v
               ~french:
                 (atom
                    "Front-end : Bonne connaissance de HTML/CSS. J'ai exercé cette compétence professionnellement lors \
                     de l'été 2018.\n\n\
